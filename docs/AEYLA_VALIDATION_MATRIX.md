...
Base auditada: checkpoint actual de la rama R07. El `BUILD_ID` del paquete
publicado es la autoridad para identificar el commit exacto de esta auditoría.
...
|---|---|---|
| Core portable | último checkpoint publicado verde en Linux, Windows y macOS; checkpoint MIDI pendiente de CI | **Simulated** |
| Quality | último checkpoint publicado verde; checkpoint MIDI pendiente de CI | **Simulated** |
| Suite configurada | 29 targets CTest, incluido control MIDI de show | **Implemented** |
| Regresión crítica actual | mapeo/reloj MIDI 100/100, estado 100/100 y cambio Art-Net file-backed sin blackout PASS con compilación estricta | **Simulated** localmente en Linux |
...
| MIDI / SHOW | mapa persistente, Learn, dos relojes de muestras, PREPARADA/ACTIVA, precarga y cambio sin blackout | **Simulated** localmente; host pendiente |
...
6. MIDI Learn/transporte de show aún no comprobado en un DAW real.
